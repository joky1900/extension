...
public class HeatMap extends JPanel{
	...
	private static final String CIRCLEPIC = "tools/bolilla.png";
	private static final String SPECTRUMPIC = "tools/colors.png";
	private Map<Integer, List<Point>> map;
	private int maxOccurance = 1;
	private int maxXValue;
	private int maxYValue;
	private BufferedImage orig;
	private BufferedImage lvlMap;
	...
	private void initMap(final List<Point> points) {
		...
		final BufferedImage mapPic = this.orig;
	...
	public BufferedImage createHeatMap(final float multiplier) {
		this.lvlMap = deepCopy(this.orig);
	...
	protected void paintComponent(Graphics g) {
		...
		g2.drawImage(hP, 0, 0, null);
	}
	
	public void changeIntensity(float intens) {
		hP = createHeatMap(intens);
		repaint();
	}
